          ...
          return this.connection.connect({
            ...
            hostVerifier: (function(_this) {
              return function(hashedKey) {
                ...
                if (hashKey === "" && _this.sshObj.server.hashInit !== "true") {
                  return true;
                } else if (hashKey === "" && _this.sshObj.server.hashInit === "true") {
                  _this.sshObj.server.hashKey = hashedKey;
                  _this.emit('msg', "Server hash:" + hashedKey);
                  return true;
                } else if (hashedKey === hashKey) {
                  return true;
                }
                console.log("4");
                _this.emit('msg', "Server hash:" + hashedKey + ", Client Hash:" + hashKey);
                return false;
              };
            })(this),
