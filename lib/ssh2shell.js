...
(function() {
  ...
  SSH2Shell = (function(_super) {
    __extends(SSH2Shell, _super);
    ...
    SSH2Shell.prototype._nextHost = function() {
      ...
      this._loadDefaults();
      if (this.sshObj.hosts === void 0 || (this.sshObj.hosts && this.sshObj.hosts.length === 0)) {
        this.sshObj.exitCommands.push("exit");
      }
    ...
    SSH2Shell.prototype._loadDefaults = function() {
      ...
      this.sshObj.sshAuth = false;
      return this._idleTime = (_ref = this.sshObj.idleTimeOut) != null ? _ref : 5000;
    };

    function SSH2Shell(sshObj) {
      this.sshObj = sshObj;
      this.connect = __bind(this.connect, this);
      this._loadDefaults = __bind(this._loadDefaults, this);
      ...
      this.on("close", (function(_this) {
        return function(had_error) {
          if (had_error) {
            return _this.emit('msg', had_error);
          } else {
      ...
      if (this.sshObj.server && this.sshObj.commands) {
        try {
                ...
                _this._stream.on("readable", function() {
                  ...
                  try {
                    ...
                    while ((data = _this._stream.read())) {
                      _results.push(_this._processData("" + data));
                    }
                    return _results;
                  } catch (_error) {
                    e = _error;
          ...
          return this.connection.connect({
            ...
            privateKey: (_ref = this.sshObj.server.privateKey) != null ? _ref : "",
            passphrase: (_ref1 = this.sshObj.server.passPhrase) != null ? _ref1 : ""
          });
        } catch (_error) {
          e = _error;
