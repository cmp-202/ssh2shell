...
(function() {
  ...
  SSH2Shell = (function(superClass) {
    ...
    SSH2Shell.prototype._initiate = function() {
      ...
      this.on("error", (ref = this.sshObj.onError) != null ? ref : (function(_this) {
      ...
      this.on("pipe", (ref1 = this.sshObj.onPipe) != null ? ref1 : (function(_this) {
      ...
      this.on("unpipe", (ref2 = this.sshObj.onUnpipe) != null ? ref2 : (function(_this) {
        return function(source) {
          if (_this.sshObj.debug) {
      ...
      this.on("data", (ref3 = this.sshObj.onData) != null ? ref3 : (function(_this) {
        return function(data) {
          return _this._processData(data);
        };
      })(this));
      return this.on("stderrData", (ref4 = this.sshObj.onStderrData) != null ? ref4 : (function(_this) {
        return function(data) {
    ...
    SSH2Shell.prototype._loadDefaults = function(callback) {
      ...
      this.sshObj.onEnd = (ref7 = this.sshObj.onEnd) != null ? ref7 : (function(_this) {
