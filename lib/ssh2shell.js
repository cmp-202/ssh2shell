...
(function() {
  ...
  SSH2Shell = (function(superClass) {
    ...
    SSH2Shell.prototype._loadDefaults = function() {
      ...
      this.on("msg", (ref2 = this.sshObj.msg.send) != null ? ref2 : (function(_this) {
        return function(message) {
          return console.log(message);
        };
      })(this));
      this.on('commandProcessing', (ref3 = this.sshObj.onCommandProcessing) != null ? ref3 : (function(_this) {
        return function(command, response, sshObj, stream) {};
      })(this));
      this.on('commandComplete', (ref4 = this.sshObj.onCommandComplete) != null ? ref4 : (function(_this) {
      ...
      this.on('commandTimeout', (ref5 = this.sshObj.onCommandTimeout) != null ? ref5 : (function(_this) {
      ...
      return this.on('end', (ref6 = this.sshObj.onEnd) != null ? ref6 : (function(_this) {
