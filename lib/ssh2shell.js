...
(function() {
  var EventEmitter, SSH2Shell, hashKey,
  ...
  SSH2Shell = (function(superClass) {
    ...
    SSH2Shell.prototype._loadDefaults = function() {
      ...
      hashKey = this.sshObj.server.hashKey.replace(/[:]/g, "").toLowerCase();
      return console.log(hashKey);
    };
      ...
      if (this.sshObj.server && this.sshObj.commands) {
        try {
          ...
          return this.connection.connect({
            ...
            hostHash: (ref2 = this.sshObj.server.hostHash) != null ? ref2 : "md5"
          });
        } catch (error) {
          e = error;
