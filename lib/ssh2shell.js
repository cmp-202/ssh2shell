  ...
  SSH2Shell = (function(superClass) {
        ...
        return function() {
          ...
          switch (true) {
            ...
            case _this.command.length > 0 && _this.command.indexOf("ssh ") !== -1:
              ...
              _this.sshObj.SSHTimer = setTimeout(function() {
                return _this.emit('onSSHTimeout', _this._buffer, 500);
              });
    ...
    SSH2Shell.prototype._processSSHPrompt = function() {
      ...
      if (!this.sshObj.sshAuth) {
        ...
        if (this.sshObj.verbose) {
          this.emit('msg', this.sshObj.server.host + ": SSH: First response: " + response);
        }
        if (passwordPrompt) {
          if (this.sshObj.debug) {
        ...
        if (this.sshObj.SSHTimer) {
          clearTimeout(this.sshObj.SSHTimer);
        }
        if (standardPrompt) {
          if (this.sshObj.debug) {
    ...
    SSH2Shell.prototype._nextHost = function() {
      ...
      return this._loadDefaults(this._sshConnect);
    };
    ...
    SSH2Shell.prototype._removeEvents = function() {
      ...
      if (this.sshObj.dataReceivedTimer) {
        return clearTimeout(this.sshObj.dataReceivedTimer);
      }
    };
    ...
    SSH2Shell.prototype._loadDefaults = function(callback) {
      ...
      this.SSHwaitTime = (ref3 = this.sshObj.SSHwaitTime) != null ? ref3 : 500;
      if (!this.asciiFilter) {
      ...
      this.onCommandProcessing = (ref4 = this.sshObj.onCommandProcessing) != null ? ref4 : (function(_this) {
        return function(command, response, sshObj, stream) {};
      })(this);
      this.onCommandComplete = (ref5 = this.sshObj.onCommandComplete) != null ? ref5 : (function(_this) {
      ...
      this.onCommandTimeout = (ref6 = this.sshObj.onCommandTimeout) != null ? ref6 : (function(_this) {
      ...
      this.onEnd = (ref7 = this.sshObj.onEnd) != null ? ref7 : (function(_this) {
    ...
    SSH2Shell.prototype._initiate = function() {
      ...
      this.on("pipe", (ref2 = this.sshObj.onPipe) != null ? ref2 : (function(_this) {
        return function(source) {
          if (_this.sshObj.debug) {
            _this.emit('msg', _this.sshObj.server.host + ": Class.pipe");
          }
          return _this.on("data", source.onData);
        };
      })(this));
      this.on("unpipe", (ref3 = this.sshObj.onUnpipe) != null ? ref3 : (function(_this) {
        return function(source) {
          if (_this.sshObj.debug) {
            _this.emit('msg', _this.sshObj.server.host + ": Class.unpipe");
          }
          return _this.removeListener('data', source.onData);
        };
      })(this));
      ...
      return this.on("stderrData", (ref5 = this.sshObj.onStderrData) != null ? ref5 : (function(_this) {
        return function(data) {
