        ...
        return function() {
          if (!_this.sshObj.disableColorFilter) {
            if (_this.sshObj.verbose) {
              _this.emit('msg', (_this.sshObj.server.host + ": text formatting filter: ") + _this.sshObj.textColorFilter + " :" + _this.textColorFilter.test(_this._buffer));
            }
            _this._buffer = _this._buffer.replace(_this.textColorFilter, "");
          }
          if (!_this.sshObj.disableASCIIFilter) {
            if (_this.sshObj.verbose) {
              _this.emit('msg', (_this.sshObj.server.host + ": ASCII filter: ") + _this.sshObj.asciiFilter + " :" + _this.asciiFilter.test(_this._buffer));
            }
          ...
          switch (true) {
            ...
            default:
              if (_this.sshObj.debug) {
                _this.emit('msg', "Timeout after hung data event");
              }
              return _this.emit('commandTimeout', _this.command, _this._buffer, _this._stream, _this._connection);
          }
        };
